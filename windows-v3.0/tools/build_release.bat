...
copy /y "%ROOT%\release\README.md" "%OUT%\README.md" >nul || goto :fail
copy /y "%ROOT%\release\EFI应急修复指南.md" "%OUT%\EFI应急修复指南.md" >nul || goto :fail
copy /y "%ROOT%\release\AI辅助安装提示词.txt" "%OUT%\AI辅助安装提示词.txt" >nul || goto :fail
copy /y "%ROOT%\release\make_usb_efi.bat" "%OUT%\make_usb_efi.bat" >nul || goto :fail
copy /y "%ROOT%\verify_source.ps1" "%OUT%\verify_source.ps1" >nul
